 ...
 *DeckPanel
 */
public class GoodPopupNotScrollablePanel extends DialogBox{
	HTMLPanel mainPanel;
	Label title;
	Label text;
	 ...
	 */
	public GoodPopupNotScrollablePanel() {
		super();
		...
		mainPanel = new HTMLPanel("<div id=\"design-handmade-popup-header\"><div id=\"design-handmade-popup-header-inner\"></div></div>" +
									"<div id=\"design-handmade-popup-content\"><div id=\"design-handmade-popup-content-inner\"> </div></div>"+
...
//		String div = "<div style = \"width:100%; height: 20px; background:red;\"></div>";
   ...
   "<tr>" +
     "<td>" +
       "<div style=\"width:12; height: 29; background:transparent url(http://localhost:8888/fi.tkk.media.xide.Main/styleImages/header_tab_bg_start.png) no-repeat \"></div>" +
    " </td>" +
     "<td style=\"width: 100%;\">" +
"<div style=\"font-size:130%; text-align:center; font-weight: bold; line-height:29px; height: 29;background:transparent url(http://localhost:8888/fi.tkk.media.xide.Main/styleImages/header_tab_bg_middle.png) repeat-x \"> XIDE message</div>" +
     "</td>" +
     "<td>" +
"<div " 
     +"id=\"close-sign\" style=\"width:12; height: 29; background:transparent url(http://localhost:8888/fi.tkk.media.xide.Main/styleImages/header_tab_bg_end.png) no-repeat\"></div>" +
    " </td>" +
  " </tr> " +
"</table>";
		this.setHTML(div);
...
//		DOM.setStyleAttribute(DOM.getChild(w.getElement(), 0), "border", "2px solid rgb(169, 169, 169)");
	...
	public void addContent(Widget w) {
		...
		mainPanel.add(w, "design-handmade-popup-content-inner");
//		DOM.setStyleAttribute(DOM.getChild(w.getElement(), 0), "border", "2px solid rgb(169, 169, 169)");
	}
	/**
	 ...
	 */
	public GoodPopupNotScrollablePanel(String titleString) {
		this();
		if (titleString != null) {
			// The title element
...
//			DOM.setStyleAttribute(title.getElement(), "borderBottom", "3px solid #A9A9A9");
	...
	public GoodPopupNotScrollablePanel(String titleString, String smallTitleString) {
		this();
...
//	}
	 ...
	 */
	public GoodPopupNotScrollablePanel(String titleString, String smallTitleString, String messageString) {
	...
	public void addCloseButton(String buttonTitle) {
		...
		Button closeButton = new Button(buttonTitle, new ClickListener() {
			...
			public void onClick(Widget sender) {
				GoodPopupNotScrollablePanel.this.hide();
			}
		});
...
//		RootPanel header = RootPanel.get("close-sign");

		RootPanel p = RootPanel.get("close-sign");
		Label label = new Label("x");
//			DOM.setElementProperty(label.getElement(), "id",
//					"label-like-link-top");
		DOM.setStyleAttribute(label.getElement(), "fontWeight", "bold");
		DOM.setStyleAttribute(label.getElement(), "fontFamily", "cursive");
		DOM.setStyleAttribute(label.getElement(), "cursor", "pointer");
		DOM.setStyleAttribute(label.getElement(), "marginLeft", "-6px");
